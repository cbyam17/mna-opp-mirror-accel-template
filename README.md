...
Accounts must be migrated from the target Salesforce instance to the source Salesforce instance either manually or via a separate integration solution, else this template must be modified in order to perform Account lookups in the target Salesforce instance.
